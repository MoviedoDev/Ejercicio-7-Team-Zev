...
const empresa: empresaCL = new empresaCL();
const Juan: personalCL = new personalCL("Juan", 1, 100);
const Ana: personalCL = new personalCL("Ana", 1, 120);
const Lin: personalCL = new personalCL("Lin", 2, 200);
const Mary: personalCL = new personalCL("Mary", 1, 50);
const Carlos: personalCL = new personalCL("Carlos", 2, 150);
